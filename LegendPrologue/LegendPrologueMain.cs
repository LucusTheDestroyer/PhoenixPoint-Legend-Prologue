...
namespace LegendPrologue
{
	...
	/// </summary>
	public class LegendPrologueMain : ModMain
	{
		/// Config is accessible at any time, if any is declared.
		// public new LegendPrologueConfig Config => (LegendPrologueConfig)base.Config;
		...
		public static LegendPrologueMain Main { get; private set; }
		...
		public override void OnModEnabled() {
			...
			Logger.LogInfo($"Enabling Legend Prologue and Tutorial...");
			...
			Main = this;
			harmony.PatchAll();
			Logger.LogInfo($"Legend Prologue and Tutorial Enabled");
		}
		...
		public override void OnModDisabled() {
			...
			Main.Logger.LogInfo($"Disabling Legend Prologue and Tutorial...");
			HarmonyLib.Harmony harmony = (HarmonyLib.Harmony)Main.HarmonyInstance;
			harmony.UnpatchAll(harmony.Id);
			Main.Logger.LogInfo($"Legend Prologue and Tutorial disabled.");
		}
